<template>
  <div class="flex flex-row-reverse  mt-10 mr-10">
    <button
      type="button"
  ...
  <h1
    class="text-slate-900 dark:text-white  text-4xl sm:text-6xl lg:text-7xl leading-none font-extrabold tracking-tight  mt-10 mb-8 sm:mt-14 sm:mb-10 max-w-6xl mx-auto"
  >
    Find
    <span
